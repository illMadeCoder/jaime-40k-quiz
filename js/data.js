/* =====================================================================
   ...
   Valid faction keys (4 outcomes):  orks  sisters  drukhari  harlequins
   ===================================================================== */
...
const FACTIONS = [
  ...
  },
  {
    ...
    why: `Hair metal taught you that excess IS a personality and that the look is half the war. ${JAIME.name}, you've got taste with teeth. You find the one strange beautiful thing in the room and you OWN it.`,
...
/* ---------- QUESTIONS (~12, rotating formats) ------------------------
   ...
   Each option has a weight vector `w` over: orks sisters drukhari harlequins. */
const QUESTIONS = [
  ...
  { type: 'classic', kicker: 'EDGE OF DARKNESS ✷ we told you so',
    ...
    options: [
      ...
      { label: `You are DELIGHTED. Not about a deal. About the look on its face when it realises you're not scared. So you sit down. You wait.`, w: { drukhari: 2, harlequins: 1 } },
      { label: `You're not surprised. You've cast this scene before. You bow, assign it the monster role, tell it where to stand. It's grateful for the direction.`, w: { harlequins: 2 } }
    ] },
  ...
  { type: 'philo', kicker: 'THE WARP ✷ a brief introduction',
    ...
    options: [
      ...
      { label: `A dimension that runs on rage and belief. You already know where yours is going.`, w: { orks: 2 } },
      { label: `Reality bends to desire out there and nothing holds. Dangerous. Yes.`, w: { drukhari: 2 } },
      { label: `Where the galaxy's story actually lives. Chaos Gods and screaming dead and burning dreams all writing themselves out at once. You know how to read this.`, w: { harlequins: 2 } }
    ] },
  ...
  { type: 'classic', kicker: 'FIELD ASSESSMENT ✷ honest answers only', q: `Your relationship to the people you fight alongside:`,
    options: [
      { label: `The mob is everything. Louder is better, more is better. Alone doesn't work.`, w: { orks: 2 } },
      { label: `Your Sisters are your purpose. The bond is sworn and you don't spend time questioning it.`, w: { sisters: 2 } },
      { label: `Useful, when they are. You don't need them to be anything else.`, w: { drukhari: 2 } },
      { label: `The troupe is everything. You just don't let them see how much.`, w: { harlequins: 2 } }
    ] },
  ...
  { type: 'music', kicker: 'NOW PLAYING ♫', q: `Pick the sound that is actually YOU at 2am:`,
    options: [
      ...
      { label: `A choir that shakes walls. Something old and enormous that has no business sounding the way it does.`, w: { sisters: 2 } },
  ...
  { type: 'philo', kicker: 'THE BIG ONE', q: `A psyker read your fate in the Emperor's Tarot. Blank-eyed, shaking, three cards face down. Fate: real?`,
    options: [
      { label: `Yes. The plan was written before you were born and it runs past your death. You know your place in it. That's not faith. That's a map.`, w: { sisters: 2 } },
      { label: `Da WAAAGH is fate. It hasn't happened to everyone yet. It will.`, w: { orks: 2 } },
  ...
  { type: 'classic', kicker: 'PICK YOUR AESTHETIC', q: `Don't overthink it. Pick the vibe:`,
    options: [
      { label: `Gold, bone, stone. Something that looks older than the room it's in.`, w: { sisters: 2 } },
  ...
  { type: 'classic', kicker: 'AFTER THE FACT ✷ no witnesses', q: `Something got broken to get you here. You:`,
    options: [
      ...
      { label: `The story required it. You played the scene correctly.`, w: { harlequins: 2 } }
    ] },
  ...
  { type: 'classic', kicker: 'WARP THEOLOGY ✷ there are no wrong answers (there are wrong answers)',
    ...
    options: [
      { img: 'assets/lore/khorne.jpg',   label: `KHORNE. Blood God. He wants one thing: the fight itself, not the reason for it, not what happens after. His followers don't argue theology. They show up and hit things. Hard not to respect that.`, w: { orks: 2 } },
      ...
      { img: 'assets/lore/slaanesh.jpg', label: `SLAANESH. The Dark Prince. Born from the Aeldari's excess and has been hunting them ever since. The doctrine: push every sensation until it cracks open. Beautiful, painful, louder, more. His followers are exhausted and they'd die before stopping.`, w: { drukhari: 2 } },
  ...
  { type: 'classic', kicker: 'THE GOD-EMPEROR ✷ he is complicated',
    ...
    options: [
      { label: `Absolute devotion. He gave everything for humanity and he's still giving. His light is what ships navigate by. We fight in his name because nothing else is worth it.`, w: { sisters: 2 } },
